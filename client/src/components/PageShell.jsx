  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-3 py-4 sm:px-6 sm:py-6 lg:px-8">
        <header
          className={`hero-panel px-4 py-5 sm:px-8 sm:py-6 ${mergeNextPanel ? 'mb-0 rounded-b-none border-b-0' : 'mb-6 sm:mb-8'}`}
          style={{
          ...
          <div className="flex flex-col gap-4 sm:gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl">
              ...
              <h1 className="mt-3 text-3xl font-black tracking-[-0.03em] text-balance sm:text-6xl">{title}</h1>
